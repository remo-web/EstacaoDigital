function edTab() {
    if (window.location.href.indexOf("estacaodigitalrio.com.br") > -1) {
    ...
    if (window.location.href.indexOf("QuemSomos") > -1) {
        ...
        document.getElementById('ed-tab-home').classList.remove('mdc-tab--active');
        document.getElementById('ed-indicator-home').classList.add('ed-hide');
    }
